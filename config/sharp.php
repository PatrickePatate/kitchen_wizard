...
use App\Sharp\Utils\SharpAuthCheckHandler;
...
return [
    ...
    'entities' => [
        'users' => \App\Sharp\Entities\UserEntity::class,
        'recipes' => \App\Sharp\Entities\RecipeEntity::class,
    ],
    ...
    'auth' => [
        ...
        'check_handler' => SharpAuthCheckHandler::class,
